...
function monthDayIsDisabled (minDate, maxDate, year, month, day, disabled) {
...
var script$2 = {
  ...
  computed: {
    ...
    days: function days () {
      ...
      return monthDays(this.newYear, this.newMonth, this.weekStart).map(function (day) { return ({
        ...
        disabled: !day || this$1.isDisabled(day)
      }); })
    }
  },
  ...
  methods: {
    ...
    isDisabled: function isDisabled (day) {
      var dt = DateTime.fromObject({ year: this.newYear, month: this.newMonth, day: day });
      ...
      [
        _vm.step === "year"
          ? _c("datetime-year-picker", {
              attrs: {
                "min-date": _vm.minDatetimeUTC,
                "max-date": _vm.maxDatetimeUTC,
                year: _vm.year
              },
        ...
        _vm.step === "date"
          ? _c("datetime-calendar", {
              attrs: {
                ...
                "disable-weekends": _vm.disableWeekends,
                "min-date": _vm.minDatetimeUTC,
                "max-date": _vm.maxDatetimeUTC,
...
var script = {
  ...
  computed: {
    ...
    popupDisabledDays: function popupDisabledDays () {
      var this$1 = this;

      if (this.disabledDays) {
        return Array.isArray(this.disabledDays) ? this.disabledDays.map(function (datetime) {
          return DateTime.fromISO(datetime).setZone(this$1.zone)
        }) : this.disabledDays
      }
      return []
    },
  ...
  methods: {
    ...
    keyDownProxy: function keyDownProxy (event) {
...
var __vue_render__ = function() {
  ...
  return _c(
    "div",
    { staticClass: "vdatetime", class: { error: _vm.hasError } },
    [
      _vm._t("before"),
      _vm._v(" "),
      _c(
          ...
          _vm.isOpen
            ? _c("datetime-popup", {
                ...
                attrs: {
                  ...
                  "hour-step": _vm.hourStep,
                  "minute-step": _vm.minuteStep,
                  "disabled-days": _vm.popupDisabledDays,
                  "disable-weekends": _vm.disableWeekends,
...
export { __vue_component__ as Datetime, version };export default plugin;
